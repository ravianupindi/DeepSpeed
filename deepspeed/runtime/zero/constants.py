...
# Enable ZeRO sharding degree to be decoupled from data parallel degree
ZERO_OPTIMIZATION_PARTIAL_SHARDING = 'partial_sharding'
ZERO_OPTIMIZATION_PARTIAL_SHARDING_DEFAULT = False
ZERO_OPTIMIZATION_SHARD_REPLICAS = 'shard_replicas'
ZERO_OPTIMIZATION_SHARD_REPLICAS_DEFAULT = 1
